...
public class GreetingService {
	...
	@RequestMapping(value = { "/", "/greeting", "/greeting-msg" }, method = RequestMethod.GET)
	public String greeting() {
		return "Welcome to RESTful services training :)";
	}

	@RequestMapping(value = "/greeting", method = RequestMethod.GET, params = { "msg" })
	...
	@RequestMapping(value = "/greeting", method = RequestMethod.POST, consumes = { "application/xml",
	...
	@RequestMapping(value = "/greeting/collection", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/greeting/entity", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/greeting/{messageId}", method = RequestMethod.PUT)
